...
const Submit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // formData.append("formcode", values.formcode);
    ...
    // formData.append("formdate", values.formdate);
    // formData.append("problemtype", values.problemtype);
    // formData.append("stopstatus", values.stopstatus);
    // formData.append("stopdate", values.stopdate);
        ...
        <form onSubmit={handleSubmit} className="row g-1">
          <div className="col-12">
            ...
            <input
              ...
              onChange={(e) =>
                setValues({ ...value, formcode: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <select
              ...
              id="section"
              className="form-control rounded-0"
              onChange={(e) => setValues({ ...value, section: e.target.value })}
            >
          ...
          <div>
            ...
            <input
              ...
              id="machinename"
              onChange={(e) =>
                setValues({ ...value, machinename: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <select
              ...
              id="shift"
              className="form-control rounded-0"
              onChange={(e) => setValues({ ...value, shift: e.target.value })}
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setValues({ ...value, operatorname: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              id="formdate"
              onChange={(e) =>
                setValues({ ...value, formdate: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <select
              ...
              id="problemtype"
              onChange={(e) =>
                setValues({ ...value, problemtype: e.target.value })
              }
            >
          ...
          <div>
            ...
            <select
              ...
              id="stopstatus"
              onChange={(e) =>
                setValues({ ...value, stopstatus: e.target.value })
              }
            >
          ...
          <div>
            ...
            <input
              ...
              id="stopdate"
              onChange={(e) =>
                setValues({ ...value, stopdate: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              id="startdate"
              onChange={(e) =>
                setValues({ ...value, startdate: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setValues({ ...value, problemdescription: e.target.value })
              }
            ></textarea>
          </div>
          <div>
